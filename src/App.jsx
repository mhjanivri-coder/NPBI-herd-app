                                ...
                                <div className="space-y-3">
                                  <div className="rounded-[24px] border border-emerald-100 bg-white p-4 shadow-sm">
                                    <div className="mb-4 rounded-2xl border border-emerald-100 bg-emerald-50/70 px-4 py-3 text-sm text-emerald-900">
                                      ...
                                      <span className="ml-1">Enter en-masse from Test Day Records or enter/edit this individual animal here; both update the same production records.</span>
                                    </div>
                                    <div className="mb-4 rounded-[24px] border border-emerald-100 bg-white p-4 shadow-sm">
                                      <div className="mb-3 text-sm font-semibold uppercase tracking-[0.18em] text-emerald-700">Individual Friday milk and composition entry</div>
                                      <div className="grid gap-3 md:grid-cols-4 xl:grid-cols-8 md:items-end">
                                        ...
                                        <TextField label="Fat %" value={productionFridayDraft.fatPct || ""} onChange={(v) => updateProductionFridayDraft("fatPct", v)} />
                                        <TextField label="SNF %" value={productionFridayDraft.snfPct || ""} onChange={(v) => updateProductionFridayDraft("snfPct", v)} />
                                        <TextField label="TS %" value={productionFridayDraft.tsPct || ""} onChange={(v) => updateProductionFridayDraft("tsPct", v)} />
                                      ...
                                      {productionFridayMessage && <div className="mt-3 rounded-2xl bg-emerald-50 px-4 py-2 text-sm text-emerald-800">{productionFridayMessage}</div>}
                                    </div>
