                                ...
                                <div className="space-y-3">
                                  <div className="rounded-[24px] border border-emerald-100 bg-white p-4 shadow-sm">
                                    <div className="mb-4 rounded-2xl border border-emerald-100 bg-emerald-50/70 px-4 py-3 text-sm text-emerald-900">
                                      <span className="font-semibold">Friday milk entry is done from Test Day Records.</span>
                                      <span className="ml-1">Saved Test Day Records automatically update this animal’s production parity and the summary below.</span>
                                    </div>
